...
import (
	...
	"github.com/allanmaral/go-expert/20-clean-arch/internal/infra/graphql/model"
...
func (ec *executionContext) field_Mutation_createOrder_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNOrderInput2githubᚗcomᚋallanmaralᚋgoᚑexpertᚋ20ᚑcleanᚑarchᚋinternalᚋinfraᚋgraphqlᚋmodelᚐOrderInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createOrder(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNOrder2ᚖgithubᚗcomᚋallanmaralᚋgoᚑexpertᚋ20ᚑcleanᚑarchᚋinternalᚋinfraᚋgraphqlᚋmodelᚐOrder(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNOrder2githubᚗcomᚋallanmaralᚋgoᚑexpertᚋ20ᚑcleanᚑarchᚋinternalᚋinfraᚋgraphqlᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v model.Order) graphql.Marshaler {
	return ec._Order(ctx, sel, &v)
}

func (ec *executionContext) marshalNOrder2ᚖgithubᚗcomᚋallanmaralᚋgoᚑexpertᚋ20ᚑcleanᚑarchᚋinternalᚋinfraᚋgraphqlᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v *model.Order) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNOrderInput2githubᚗcomᚋallanmaralᚋgoᚑexpertᚋ20ᚑcleanᚑarchᚋinternalᚋinfraᚋgraphqlᚋmodelᚐOrderInput(ctx context.Context, v interface{}) (model.OrderInput, error) {
